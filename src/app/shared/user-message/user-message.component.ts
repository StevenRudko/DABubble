...
export class UserMessageComponent {
  ...
  @Input() messagesToday: { timestamp: number; userMessageId: string; authorId: string; message: string; hours: number; minutes: number }[] = [];
  @Input() messagesOld: { timestamp: number; userMessageId: string; authorId: string; message: string; hours: number; minutes: number }[] = [];
